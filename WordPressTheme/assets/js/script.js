...
var show = jQuery(".p-mv,.p-page-teachers__wrapper,.p-page-information__wrapper,.p-contact-top__buttons,.p-page-single-mv,.l-page-class__times,.p-overview,.l-page-performance-classes__inner").offset();
