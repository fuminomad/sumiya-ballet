...
<section class="p-contact l-contact" id="contact">
  ...
  <div class="passing">
    ...
    <div class="p-contact__texts">
      ...
      <span>当バレエ団からのメールが迷惑メールフォルダに</span><span>振り分けられる可能性もございますので</span><span>ご確認頂けると幸いでございます。</span><br><span>また、迅速な対応を心がけておりますが、</span><span>休業日その他の関係でお返事に</span><span>数日かかる場合がございます。</span><br><span>お問い合わせをいただきましてから</span><span>5日以上、当バレエ団より連絡がない場合は、</span><span>メール送信のトラブルも考えられますので、</span><span>お電話でご確認いただければ幸いでございます。</span></p>
