...
function my_script_init()
{
   //グーグルフォントとかの読み込み
	...
	wp_enqueue_style( 'my', get_template_directory_uri() . '/assets/css/style.css', array(), '1.1.7', 'all' );
	...
	wp_enqueue_script( 'my', get_template_directory_uri() . '/assets/js/script.js', array( 'jquery' ), '1.0.5', true );
